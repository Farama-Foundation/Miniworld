...
obss = np.zeros(shape=(num_demos, max_steps, 3, 60, 80), dtype=np.uint8)
poss = np.zeros(shape=(num_demos, max_steps, 3), dtype=np.float32)
active = np.zeros(shape=(num_demos, max_steps, 1), dtype=np.float32)
